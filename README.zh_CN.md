...
New API Balance Orb 是一个基于 Tauri v2 的 Windows 桌面小部件，用于轮询 New API 兼容的余额接口并实时显示账户余额。每分钟自动刷新，仅显示数字余额，并提供系统托盘菜单用于打开小部件、修改设置、检查更新和退出程序。
...
- 托盘菜单包含设置、检查更新、项目地址和退出。
- 简体中文系统显示简体中文，其它系统语言显示英文。
- Windows 正式版卸载时会清理本应用在 `Run` 和 `StartupApproved\Run` 下的开机启动注册表项。
